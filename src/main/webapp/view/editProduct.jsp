...
<div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-md mx-auto my-10">
  ...
  <form action="${pageContext.request.contextPath}/home" method="post" class="space-y-4">
    ...
    <div>
      ...
      <input type="number" id="price" name="price" value="${product.price}" required step="0.1"
             class="w-full border border-gray-300 rounded px-3 py-2 focus:ring focus:ring-blue-200" />
    </div>
    ...
    <div class="flex justify-between mt-6">
      ...
      <button type="submit"
              class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded">Lưu</button>
    </div>
  </form>
</div>